...
public class NodoNEQ extends NodoOperadorBinario{

	public NodoNEQ(NodoExpresion e1, NodoExpresion e2) {
		super(e1, e2);
	}
	...
	public Instruccion instruccion() {return InstruccionP.NEQ();}
