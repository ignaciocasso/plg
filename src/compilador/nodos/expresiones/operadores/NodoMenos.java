...
public class NodoMenos extends NodoOperadorBinario{

	public NodoMenos(NodoExpresion e1, NodoExpresion e2) {
		super(e1, e2);
	}
	...
	public Instruccion instruccion() {return InstruccionP.SUB();}
