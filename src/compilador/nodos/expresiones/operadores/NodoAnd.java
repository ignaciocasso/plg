...
public class NodoAnd extends NodoOperadorBinario{

	public NodoAnd(NodoExpresion e1, NodoExpresion e2) {
		super(e1,e2);
	}
	
	public NodoTipo calcularTipo(NodoTipo tipo1, NodoTipo tipo2) throws TypeException {
		if (!tipo1.esBooleano() || !tipo2.esBooleano()){
			throw new TypeException(this, "tipos incompatibles con el operandor &&");
		}
		return NodoTipoPrimitivo.BOOL;
	}
	
	public Instruccion instruccion() {return InstruccionP.AND();}
}
