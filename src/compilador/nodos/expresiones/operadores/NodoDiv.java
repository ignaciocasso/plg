...
public class NodoDiv extends NodoOperadorBinario{

	public NodoDiv(NodoExpresion e1, NodoExpresion e2) {
		super(e1, e2);
	}
	...
	public Instruccion instruccion() {return InstruccionP.DIV();}
