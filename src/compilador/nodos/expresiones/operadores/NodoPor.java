...
public class NodoPor extends NodoOperadorBinario{

	public NodoPor(NodoExpresion e1, NodoExpresion e2) {
		super(e1, e2);
	}
	...
	public Instruccion instruccion() {return InstruccionP.MUL();}
